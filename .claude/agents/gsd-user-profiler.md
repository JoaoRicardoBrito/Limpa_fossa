...
<reference>
@C:/Users/Johau/PROJETOS/Limpa_fossa/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Users/Johau/PROJETOS/Limpa_fossa/.claude/get-shit-done/references/user-profiling.md` to load:
